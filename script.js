function register(){
    ...
    //Send request
    request.send("customer_ID=" + customer_ID + "&email=" + email + "&password=" + password + "&firstname=" + firstname + "&lastname=" + lastname + "&phonenumber=" + phonenumber + "&AddressLine1=" + AddressLine1 + "&AdressLine2=" + AdressLine2 + "&City=" + City + "&Postcode=" + Postcode);
}